...
SQL is a querying language used to interact with a relational database. A Relational database is composed of tables that have one or more relationships to one another.

2. Why do tables need a `primary key`?

For database normalization. In order to avoid bugs.
...
You need a intermediary table that demonstrates the relationship between two or more tables.
